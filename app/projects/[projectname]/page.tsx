    ...
    <div>
      ...
      {showAddTaskName && (
        <>
          ...
          <button
            className="ml-8 text-green-700 cursor-pointer"
            onClick={addNewTaskk}
          >
            Add
          </button>
      ...
      <button className="ml-128 cursor-pointer block" onClick={addNewTask}>
        Add New Task
      </button>
      <button className="mt-4 text-red-700" onClick={handleDeleteProject}>
        Delete Project
      </button>
    </div>
  );
